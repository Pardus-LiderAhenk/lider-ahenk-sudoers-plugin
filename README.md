...
Lider Ahenk sudoers plugin enables us to add user to sudo group.
...
1. Clone the plugin project by running `git clone https://github.com/Pardus-Kurumsal/lider-ahenk-sudoers-plugin.git`.
