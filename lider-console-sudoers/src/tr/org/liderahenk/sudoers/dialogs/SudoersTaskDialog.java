...
/**
 * Task execution dialog for sudoers plugin.
 * 
 */
public class SudoersTaskDialog extends DefaultTaskDialog {
	
	private static final Logger logger = LoggerFactory.getLogger(SudoersTaskDialog.class);
	
	// TODO do not forget to change this constructor if SingleSelectionHandler is used!
	public SudoersTaskDialog(Shell parentShell, Set<String> dnSet) {
